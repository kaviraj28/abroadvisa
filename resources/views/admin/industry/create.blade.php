...
@section('title', 'Create New Industry - Visa Abroad')
    ...
    <div class="content">
        <div class="card container-fluid mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Create Industry</h5>
            ...
            <div class="card-body p-0">
                <form class="row" method="POST" action="{{ route('industry.store') }}" enctype="multipart/form-data">
                    @csrf
