                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control br-8" type="text" name="banner_small_title"
                                                value="{{ old('banner_small_title') }}" placeholder="Enter Small Title">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control br-8" type="text" name="banner_link_text"
                                                value="{{ old('banner_link_text') }}" placeholder="Enter Link Text">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control br-8" type="text" name="banner_link_url"
                                                value="{{ old('banner_link_url') }}" placeholder="Link URL">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
