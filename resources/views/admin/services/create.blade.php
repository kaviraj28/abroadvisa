...
@section('title', 'Create New Services - Visa Abroad')
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control br-8" type="text"
                                                        name="banner_small_title" value="{{ old('banner_small_title') }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control br-8" type="text" name="banner_big_title"
                                                        value="{{ old('banner_big_title') }}" placeholder="Enter Big Title">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                    <label for="banner_description">Banner Description</label>
                                                    <textarea class="form-control br-8" name="banner_description" rows="4" placeholder="Enter Banner Description">{{ old('banner_description') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control br-8" type="text"
                                                        name="banner_link_text" value="{{ old('banner_link_text') }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control br-8" type="text"
                                                        name="banner_link_url" value="{{ old('banner_link_url') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control br-8" type="text" name="roadmapinfo" placeholder="Enter Roadmap Info">{{ old('roadmapinfo') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group mb-3 mt-2">
                                                    ...
                                                    <div class="custom-file">
                                                        ...
                                                        <input class="" id="banner_id" type="hidden"
                                                            name="roadmapimage" value="{{ old('roadmapimage') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control br-8" type="text" name="industryinfo" placeholder="Enter Industry Info">{{ old('industryinfo') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control br-8" type="text" name="projectinfo" placeholder="Enter Project Info">{{ old('projectinfo') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control br-8" type="text" name="pricinginfo" placeholder="Enter Pricing Info">{{ old('pricinginfo') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control br-8" type="text" name="faqtitle"
                                                        value="{{ old('faqtitle') }}" placeholder="Enter Faq Title">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="faqinfo">Faq Info</label>
                                                    <textarea class="form-control br-8" type="text" name="faqinfo" placeholder="Enter faq Info">{{ old('faqinfo') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group mb-3 mt-2">
                                                    ...
                                                    <div class="custom-file">
                                                        ...
                                                        <input class="" id="video_id" type="hidden"
                                                            name="faqimage" value="{{ old('faqimage') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
