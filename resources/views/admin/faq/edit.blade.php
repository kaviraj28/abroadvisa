...
@section('title', 'Edit ' . $faq->name . ' - Visa Abroad')
                    ...
                    <div class="col-md-3">
                        <div class="card-body card shadow br-8">
                            ...
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-5" id="service" name="service">
                                    <option class="p-3" value="0">General</option>
                                    @if ($services->isNotEmpty())
                                        @foreach ($services as $key => $value)
                                            <option class="p-3" value="{{ $value->id }}"
                                                {{ $value->id == $faq->service ? 'selected' : '' }}>{{ $value->name }}
                                            </option>
                                        @endforeach
                                    @endif
                                </select>
